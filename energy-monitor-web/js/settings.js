import {
  ...
  startStatusWatcher,
  applyTheme          // FIX: import dari auth-guard, tidak perlu duplikasi
} from "./auth-guard.js";
...
// ================= DEFAULTS =================
const DEFAULTS = {
  currency: "IDR", tariff: 1444.70, theme: "dark", language: "en",
...
const LANG = {
  en: {
    ...
    pricingTitle: "💰 Energy Pricing", currencyLabel: "Currency", tariffLabel: "Tariff per kWh", savePricing: "Save Settings",
    accountTitle: "👤 Account", nameLabel: "Display Name", emailLabel: "Email", saveProfile: "Update Profile",
    appearanceTitle: "🎨 Appearance", themeLabel: "Theme", themeDark: "Dark", themeDarker: "Darker", themeLight: "Light",
    langLabel: "Language", saveAppearance: "Save Appearance",
    notifTitle: "🔔 Notifications & Dashboard",
    notifDevice: "Device connected notification", notifDeviceSub: "Show toast when device is plugged in",
    notifDisconnect: "Device disconnected notification", notifDisconnectSub: "Show toast when device is unplugged",
    notifSession: "Session saved notification", notifSessionSub: "Show toast when session is saved",
    refreshLabel: "Dashboard refresh interval", saveNotif: "Save Preferences",
    dataTitle: "📊 Data Control", dataSub: "Export or delete all monitoring history data stored on this device.",
    exportAll: "↓ Export All History CSV", deleteAll: "✕ Delete All History",
    aboutTitle: "ℹ About", aboutApp: "Application", aboutVer: "Version", aboutHw: "Hardware", aboutCloud: "Cloud",
  },
  id: {
    settingsTitle: "Pengaturan", settingsSub: "Kelola preferensi dan data kamu",
    pricingTitle: "💰 Harga Energi", currencyLabel: "Mata Uang", tariffLabel: "Tarif per kWh", savePricing: "Simpan Pengaturan",
    accountTitle: "👤 Akun", nameLabel: "Nama Tampilan", emailLabel: "Email", saveProfile: "Perbarui Profil",
    appearanceTitle: "🎨 Tampilan", themeLabel: "Tema", themeDark: "Gelap", themeDarker: "Lebih Gelap", themeLight: "Terang",
    langLabel: "Bahasa", saveAppearance: "Simpan Tampilan",
    notifTitle: "🔔 Notifikasi & Dashboard",
    notifDevice: "Notifikasi device terhubung", notifDeviceSub: "Tampilkan notifikasi saat device dicolok",
    notifDisconnect: "Notifikasi device dicabut", notifDisconnectSub: "Tampilkan notifikasi saat device dicabut",
    notifSession: "Notifikasi sesi tersimpan", notifSessionSub: "Tampilkan notifikasi saat sesi disimpan",
    refreshLabel: "Interval refresh dashboard", saveNotif: "Simpan Preferensi",
    dataTitle: "📊 Kontrol Data", dataSub: "Ekspor atau hapus semua riwayat monitoring di perangkat ini.",
    exportAll: "↓ Ekspor Semua Riwayat CSV", deleteAll: "✕ Hapus Semua Riwayat",
    aboutTitle: "ℹ Tentang", aboutApp: "Aplikasi", aboutVer: "Versi", aboutHw: "Perangkat Keras", aboutCloud: "Cloud",
  }
};
...
function applyLanguage(lang) {
  ...
  set("txt-settings-title", t.settingsTitle);  set("txt-settings-sub",  t.settingsSub);
  set("txt-pricing-title",  t.pricingTitle);   set("txt-currency-label",t.currencyLabel);
  set("txt-tariff-label",   t.tariffLabel);    set("txt-save-pricing",  t.savePricing);
  set("txt-account-title",  t.accountTitle);   set("txt-name-label",    t.nameLabel);
  set("txt-email-label",    t.emailLabel);     set("txt-save-profile",  t.saveProfile);
  set("txt-appearance-title",t.appearanceTitle);set("txt-theme-label",  t.themeLabel);
  set("txt-theme-dark",     t.themeDark);      set("txt-theme-darker",  t.themeDarker);
  set("txt-theme-light",    t.themeLight);     set("txt-lang-label",    t.langLabel);
  set("txt-save-appearance",t.saveAppearance);
  set("txt-notif-title",    t.notifTitle);     set("txt-notif-device",  t.notifDevice);
  set("txt-notif-device-sub",t.notifDeviceSub);set("txt-notif-disconnect",t.notifDisconnect);
  set("txt-notif-disconnect-sub",t.notifDisconnectSub);
  set("txt-notif-session",  t.notifSession);   set("txt-notif-session-sub",t.notifSessionSub);
  set("txt-refresh-label",  t.refreshLabel);   set("txt-save-notif",    t.saveNotif);
  set("txt-data-title",     t.dataTitle);      set("txt-data-sub",      t.dataSub);
  set("txt-export-all",     t.exportAll);      set("txt-delete-all",    t.deleteAll);
  set("txt-about-title",    t.aboutTitle);     set("txt-about-app",     t.aboutApp);
  set("txt-about-ver",      t.aboutVer);       set("txt-about-hw",      t.aboutHw);
  set("txt-about-cloud",    t.aboutCloud);
}

// ── Highlight tombol tema aktif ──
...
// FIX: gunakan applyTheme dari auth-guard (tidak duplikasi lagi)
...
document.getElementById("btn-save-settings").addEventListener("click", () => {
  ...
  settings = { ...settings, currency, tariff };
...
document.getElementById("btn-save-notif").addEventListener("click", () => {
  ...
  settings = { ...settings, notifDevice, notifDisconnect, notifSession, refreshInterval };
  localStorage.setItem(`sem_settings_${uid}`, JSON.stringify(settings));
